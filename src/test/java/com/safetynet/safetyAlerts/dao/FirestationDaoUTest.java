...
public class FirestationDaoUTest {
    ...
    public void setUp() {
		...
		//Mockito.when(dataModel.getFirestations()).thenReturn(firestations);	
	}
	...
	public void putFirestationTest() throws Exception {		
		...
		FirestationModel firestationP = new FirestationModel("fire14444","address14444");
